...
class TestValidAnswer(BaseCase):
    ...
    def test_request_cookies(self, method):
        ...
        __temp_dict = self.__cookies[2]  # 0 - invalid value, 1 - invalid key, 2 - valid key and value
    ...
    def test_request_headers(self, method):
        ...
        __temp_dict = self.__headers[2]  # 0 - invalid value, 1 - invalid key, 2 - valid key and value
        for key in __temp_dict:
