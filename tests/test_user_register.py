...
class TestUserRegister(BaseCase):
    ...
    @allure.description("This test checks registration of user with invalid email")
    ...
    @allure.description("This test checks registration of user without any required field")
    ...
    @allure.description("This test checks registration of user with names length 1 character")
    ...
    @allure.description("This test checks registration of user with names length more 250 characters")
    @pytest.mark.parametrize('field', string_fields)
